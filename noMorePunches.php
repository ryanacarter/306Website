...
<body>
	    ...
	    <div class="grid_12">
	      <?php echo '<center><h1>' . $firstName . ' ' . $lastName . ' DOES NOT HAVE ENOUGH PUNCHES!!!' . '</h1></center>' ?>

	      <?php echo '<center><h2>' . $firstName . ' ' . $lastName . '\'s Punch Balance = ' . $punches . ' punch(es).</h2></center>' ?>
	
		<br><br><br><br><br><br><br><br>
	    </div>
	
    <a href="main.php?rfid=<?php echo $rfid ?>" class="button" id="balance">
      <button type="button" style=" position: relative; right:200px; width: 300px; height:50px; ">Go Back</button>
    </a>
