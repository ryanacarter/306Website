<?php
	...
	if ( isset( $_POST[ 'amount' ] ) ) {
		...
		if ( $flex > $amount ) {	
			...
			header( "Location: noMoreFlex.php?rfid=" . $rfid );
	}
	else {
...
<body>
	...
	Flex Amount: <input type="text" name="amount" id = "amount"><br><br>
    ...
    <a href="main.php?rfid=<?php echo $rfid ?>" class="button" id="balance">
      	<button type="button" style="border: 0; background: transparent; 
			...
			<img src="img/Go-Back.gif" width="350" height="75px" alt="submit" />
		</button>
    </a>
    </a>
